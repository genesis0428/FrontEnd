...
console.log('myfunc3 result : ' + myfunc3(10))      //리턴값이 있을 때 변수저장 사용하지 않고 출력
...
myfunc5(999);                   //리턴값 없다. 리턴문 자체가 없기 때문.
